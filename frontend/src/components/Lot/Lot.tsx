...
const Lot: React.FC<LotProps> = ({auction}) => {
    ...
    const placeBid = () => {
        ...
        if (!bidAmount || bidAmount <= (auction.currentBid || auction.startPrice)) {
            setError(`Bid must be higher than $${auction.currentBid || auction.startPrice}`);
            return;
        }
                    ...
                    <div className="bg-white rounded-lg p-6 w-full max-w-md shadow-lg">
                        ...
                        <div className="mb-4">
                            ...
                            <input
                                ...
                                placeholder={`Enter more than $${auction.currentBid || auction.startPrice}`}
                ...
                <div className="flex-1 flex flex-col justify-between">
                    <div>
                        <div>
                            ...
                            <p className="text-lg text-gray-600">Start Price: ${auction.startPrice}</p>
                            {auction.currentBid && (
                                <p className="text-lg text-gray-600">Current Bid: ${auction.currentBid}</p>
                            )}
                            <p className="text-sm text-gray-600 mt-1">
                                Ends: {new Date(auction.endTime).toLocaleString()}
                            </p>
